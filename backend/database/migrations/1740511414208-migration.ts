...
export class Migration1740511414208 implements MigrationInterface {
    name = 'Migration1740511414208'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "solutions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "userInChargeId" uuid, "name" character varying(50) NOT NULL, "clientDepartment" character varying(100) NOT NULL, "benefit" numeric(10,2), "investment" numeric(10,2), "status" character varying NOT NULL, "priority" character varying NOT NULL, "category" character varying NOT NULL, "description" text NOT NULL, "justification" text NOT NULL, "orchestration" text NOT NULL, CONSTRAINT "PK_05589f12803f420b119df2f6170" PRIMARY KEY ("id"))`);
